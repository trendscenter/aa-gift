        ...
        if isdefined(self.inputs.network_summary_opts):
			network_summary_opts = self.inputs.network_summary_opts;
                	...
                	try:
                    		...
                    		network_threshold = 1;
                	commandstr.append("network_summary_opts.threshold = %d;" % (network_threshold));

                	# Anatomical file
                	try:
                    		structFile = self.inputs.network_summary_opts['structFile'];
                    		commandstr.append("network_summary_opts.structFile = %s;" % (structFile));
                	except:
                	...
                	commandstr.append("network_summary_opts.format = %s;" % (file_format));
	                ...
	                commandstr.append("network_summary_opts.convert_to_z = %s;" % (convert_to_z));
